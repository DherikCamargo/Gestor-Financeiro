...
const Transaction = {    //adicionar e remover transações 
    all: Storage.get(),
...
const DOM = {
    ...
    const amount = Utils.formatCurrency(transaction.amount)
          ...
          const html  = `    
          <td class="descrption">${transaction.description}</td>
...
const Utils = {    //=============FORMATAÇÃO DE DINHEIRO BRL===================
     formatAmount(value){
...
const Form = {
    ...
    submit(event) {
       ...
       try{
           Form.validateFields()         
        const trsanction = Form.formatValues()
        //salvar
        Transaction.add(trsanction)
